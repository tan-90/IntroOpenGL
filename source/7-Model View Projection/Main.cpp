...
int main()
{
	...
	while (!glfwWindowShouldClose(Window))
	{
		...
		// Cria uma matriz model de rotacao em funcao do tempo
		glm::mat4 Model;
		Model = glm::rotate(Model, (float)glfwGetTime() * glm::radians(-45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		// Cria uma matriz view de translacao em funcao do tempo
		glm::mat4 View;
		View = glm::translate(View, glm::vec3(0.0f, 0.0f, (sin(glfwGetTime()) + 1.5f) * -5.0f));
