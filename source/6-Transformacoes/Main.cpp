...
int main()
{
	...
	while (!glfwWindowShouldClose(Window))
	{
		...
		// Cria uma matriz de transformação de rotação em funcao do tempo
		glm::mat4 Transformation;
		Transformation = glm::rotate(Transformation, (float)glfwGetTime() * glm::radians(45.0f), glm::vec3(0.0f, 0.0f, 1.0f));
