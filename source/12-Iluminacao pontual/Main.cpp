...
GLfloat DiffuseLigthStrength = 0.1f;
...
int main()
{
	...
	Mesh LoadedMesh = LoadObjToMesh("res/sword.obj", glm::vec3(RGB_INT_DEC(253), RGB_INT_DEC(160), RGB_INT_DEC(255)));

	Mesh LampMesh = LoadObjToMesh("res/sphere.obj", LightColor);
