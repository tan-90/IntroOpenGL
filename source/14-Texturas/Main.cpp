...
int main()
{
	...
	Mesh LoadedMesh = LoadObjToMesh("res/pendant.obj", glm::vec3(RGB_INT_DEC(255), RGB_INT_DEC(255), RGB_INT_DEC(255)));

	Mesh LampMesh = LoadObjToMesh("res/cube.obj", glm::vec3(1.0f));
